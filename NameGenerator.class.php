...
class NameGenerator
{
    ...
    public static function pirateName()
    {
        ...
        $pirate_title   = ["Captain", "Salty", "Bloody", "Captain", "Capn"];
        $pirate_male    = [
